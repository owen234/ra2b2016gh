...
#include "fill_hists_loop_v2c.c"

   void run_fill_hists_loop_v2c( const char* indir = "fnal-prod-v7-skims-slimmed" ) {

      char fpat[10000] ;
      char sample_name[100] ;
      TChain* ch ;
      int n_added ;
      fill_hists_loop_v2c* fhl ;
...
///   fhl = new fill_hists_loop_v2c( ch, sample_name ) ;
///   fhl -> Loop() ;
