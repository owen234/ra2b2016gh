...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("fnal-prod-v11-skims/tree_LDP/tree_QCD_HT-500to700.root/tree");
      chain->Add("fnal-prod-v11-skims/tree_signal/tree_QCD_HT-500to700.root/tree");
      chain->Add("fnal-prod-v11-skims/tree_LDP/tree_QCD_HT-700to1000.root/tree");
      chain->Add("fnal-prod-v11-skims/tree_signal/tree_QCD_HT-700to1000.root/tree");
      chain->Add("fnal-prod-v11-skims/tree_LDP/tree_QCD_HT-1000to1500.root/tree");
      chain->Add("fnal-prod-v11-skims/tree_signal/tree_QCD_HT-1000to1500.root/tree");
      chain->Add("fnal-prod-v11-skims/tree_LDP/tree_QCD_HT-1500to2000.root/tree");
      chain->Add("fnal-prod-v11-skims/tree_signal/tree_QCD_HT-1500to2000.root/tree");
      chain->Add("fnal-prod-v11-skims/tree_LDP/tree_QCD_HT-2000toInf.root/tree");
      chain->Add("fnal-prod-v11-skims/tree_signal/tree_QCD_HT-2000toInf.root/tree");
      tree = chain;
#endif // SINGLE_TREE
