#ifndef create_model_ratio_hist4_c
#define create_model_ratio_hist4_c
...
#include "../get_hist.h"
   ...
   void create_model_ratio_hist4( const char* model_pars_file = "../outputfiles/model-pars-qcdmc3.txt",
      ...
      /////////     ) ;
                  ...
                  model_ratio_val = par_val_ht_njet[bi_ht][bi_nj] * par_val_ht_mht[bi_ht][bi_mht] * par_val_nb[bi_nb] ;
                  model_ratio_err = model_ratio_val * sqrt(
                         pow( par_err_ht_njet[bi_ht][bi_nj]/par_val_ht_njet[bi_ht][bi_nj], 2. )
                      +  pow( par_err_ht_mht[bi_ht][bi_mht]/par_val_ht_mht[bi_ht][bi_mht], 2. )
                      +  pow( par_err_nb[bi_nb]/par_val_nb[bi_nb], 2. )
                    ) ;
	...
	std::cout << qcdmc_val << " " << model_val << " " << diff_val << std::endl;
      ...
      saveHist("outputfiles/model-ratio-hist4.root", "h*" ) ;

   } // create_model_ratio_hist4
